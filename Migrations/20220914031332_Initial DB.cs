    ...
    public partial class InitialDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Courses",
                columns: new[] { "CourseId", "CourseName", "Title" },
                values: new object[,]
                {
                    { 1, "Introduction To Web Development", "Introduction To Web Development" },
                    { 2, "Advance Web Development", "Advance To Web Development" }
                });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "OrderDate", "OrderNumber", "UserId" },
                values: new object[] { 1, new DateTime(2022, 9, 14, 3, 13, 32, 262, DateTimeKind.Utc).AddTicks(8837), "12345", null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 20, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Sakib Hasan", "Hasan" },
                    { 2, 22, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Liton", "Das" },
                    { 3, 25, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Taskin", "Ahmed" }
                });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "TeacherId", "Age", "FirstName", "IsActive", "LastName" },
                values: new object[,]
                {
                    { 1, 30, "Marie", true, "Lina" },
                    { 2, 28, "Rihan", true, "Munabih" },
                    { 3, 29, "Jhon", true, "Baker" },
                    { 4, 29, "Mark", true, "Jacobs" },
                    { 5, 35, "Ahmed", true, "Zamil" }
                });

            migrationBuilder.InsertData(
                table: "StudentCourses",
                columns: new[] { "StudentCourseId", "CourseId", "Note", "StudentId" },
                values: new object[,]
                {
                    { 1, 2, "Fruit pies", 1 },
                    { 2, 2, "Student 2 takes course 2", 2 },
                    { 3, 1, "Student 3 takes course 3", 3 }
                });

            migrationBuilder.InsertData(
                table: "Subjects",
                columns: new[] { "SubjectId", "CourseId", "IsMajor", "SubjectName", "SubjectTitle", "TeacherId" },
                values: new object[,]
                {
                    { 1, 2, true, "JAVA", "JAVA", 1 },
                    { 6, 1, true, "C Programming", "C Programming", 1 },
                    { 2, 2, true, "ASP.NET", "ASP.NET", 2 },
                    { 3, 2, true, "ANGULAR", "ANGULAR", 3 },
                    { 4, 1, true, "OOP Concepts", "OOP Concepts", 4 },
                    { 5, 1, true, "Programming Fundamentals ", "Programming Fundamentals ", 5 }
                });

            migrationBuilder.InsertData(
                table: "SubjectGrades",
                columns: new[] { "SubjectGradeId", "Grade", "GradePoint", "StudentId", "SubjectId" },
                values: new object[,]
                {
                    { 1, "A+", 4.0, 1, 1 },
                    { 4, "A+", 4.0, 2, 1 },
